...
MinutesPlayed[c(1,3,5), c(8,9,10)]
MinutesPlayed[1, c(8,9,10)]
...
legend("bottomleft", inset=0.01, legend=Players, col=c(1:10), pch=15:18, horiz=FALSE)

Salary[c(1,10),]
Salary[1,]
Salary[1, , drop=F] # to not drop dimension.
matplot(t(Salary), type="b", pch=15:18, col=c(1,2,3))
legend("bottomleft", inset=0.01, legend=Players, col=c(1,2,3), pch=15:18, horiz=FALSE)
